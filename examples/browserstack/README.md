...
1. Get a [BrowserStack](https://www.browserstack.com/) account.
...
4. Run the command `testem -l bs_chrome ci` to test out the setup with just the Chrome browser hosted BrowserStack.
