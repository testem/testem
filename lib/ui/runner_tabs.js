...
var TabWidth = constants.TabWidth = 15     // column width of each tab
var TabStartLine = constants.TabStartLine = 4  // row from the top to start drawing tabs
var TabHeight = constants.TabHeight = 4     // the height in rows of each tab
var TabStartCol = constants.TabStartCol = 1   // col from the left to start drawing tabs
var LogPanelUnusedLines = constants.LogPanelUnusedLines = 8  // number of rows in the UI does not belong to the log panel
