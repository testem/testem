...
var AppView = module.exports = View.extend({
    ...
    , initialize: function(attrs){
        ...
        runners.on('add', function(runner, options){
            ...
            if (name === self.get('currentTabName')) {
                self.set('currentTab', runners.models.indexOf(runner))
            }
        })
    ...
    , nextTab: function(){
        ...
        var runner = this.runners().models[currentTab]
        // this.set('currentTabName', runner.get('name'))
