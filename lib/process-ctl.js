...
ProcessCtl.prototype.onStart = function() {
  ...
  this.process.on('close', this._boundOnClose);
  this.process.on('error', this._boundOnError);
...
ProcessCtl.prototype.removeListeners = function() {
  this.process.removeListener('close', this._boundOnClose);
  this.process.removeListener('error', this._boundOnError);
};
