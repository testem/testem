...
class FileWatcher extends EventEmitter {
   ...
   * patterns (for example, a file the dev server started serving after startup). Glob
   * patterns are not accepted here — only real paths; pattern-based includes stay in
   * config.
   *
