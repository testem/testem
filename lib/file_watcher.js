...
module.exports = class FileWatcher extends EventEmitter {
   ...
   *
   * Synchronous teardown completes before the returned promise resolves, so callers that
   * must release handles before continuing can rely on that ordering (see assert_concrete_file_watch_add_path).
   *
