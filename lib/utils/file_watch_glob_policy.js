...
/**
 * Build the include / ignore pattern lists used by `FileWatcher` with the watch engine
 * (policy filtering; the engine watches cwd and applies these patterns). Single place for glob +
 * ignore semantics.
 *
 ...
 * @param {object} [matchOptions] - forwarded to the path matcher (via path_pattern_match).
 * @returns {boolean}
 */
