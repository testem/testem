...
/*
  ...
  framework:            [String]  test framework to use (jasmine [alias for modern Jasmine], jasmine2, qunit, mocha, mocha+chai, custom, tap)
  ...
  serve_files:          [Array]   list of files or file patterns to inject into the built-in runner playground (defaults to src_files)
