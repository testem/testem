...
var SplitLogPanel = exports.SplitLogPanel = View.extend({
    ...
    , initialize: function(attrs){
        ...
        this.observe(messages, 'add remove', function(){
    ...
    , hasMessages: function(){
        return this.browser.hasMessages()
    }
    , hasResults: function(){
    ...
    , syncDimensions: function(options){
        ...
        log.info(JSON.stringify(bottomPanelAttrs, null, '  '))
...
var BrowserTab = exports.BrowserTab = View.extend({
    ...
    , initialize: function(){
        ...
        try{
            ...
            log.info('making split panel for ' + browser.get('name') + ' which is ' + visible)
