...
var LogPanel = exports.LogPanel = View.extend({
    ...
    , getLogTextLines: function(){
        log.info('getLogTextLines')
        if (this.browser.get('type') === 'browser')
            return this.getLogTextFromTestResults()
        else
            return this.getLogTextFromLogOutputChunks().toArray()
    }
    , getLogTextFromLogOutputChunks: function(){
        var browser = this.browser
        var logOutputChunks = browser.get('logOutputChunks')
        log.info('logOutputChunks.length: ' + logOutputChunks.length)
        return logOutputChunks
    }
    , getLogTextFromTestResults: function(){
        log.info('getLogTextFromTestResults')
    ...
    , render: function(firstOrLast){
        ...
        function renderLine(i){    
            var lineObj = lines[i + vertScrollOffset]
...
var BrowserTab = exports.BrowserTab = View.extend({
    ...
    , renderResults: function(){
        ...
        log.info('renderResults: allPassed: ' + browser.get('allPassed'))
