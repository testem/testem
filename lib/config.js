...
Config.prototype.defaults = {
  ...
  socket_heartbeat_timeout: function() {
    var browserDisconnectTimeout = this.get('browser_disconnect_timeout');
    var defaultBrowserDisconnectTimeout = this.defaults.browser_disconnect_timeout;
