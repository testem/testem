...
module.exports = class App extends EventEmitter {
  ...
  getServer() {
    return Bluebird.resolve(this.startServer()).disposer(() => this.stopServer());
  }
  ...
  fileWatch() {
    return Bluebird.resolve(this.configureFileWatch()).disposer(() => {});
  }
  ...
  getRunners() {
    return Bluebird.resolve(fromCallback(callback => {
