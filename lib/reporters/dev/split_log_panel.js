...
function toCharmText(segments) {
  var result = styledString('');
  (segments || []).forEach(function(segment) {
    result = result.concat(styledString(segment.text, {
...
module.exports = View.extend({
  ...
  syncMessages: function(options) {
    this.bottomPanel.set('text', toCharmText(this.getMessagesText()), options);
  },
  syncResultsDisplay: function(options) {
    this.topPanel.set('text', toCharmText(this.getResultsDisplayText()), options);
  },
