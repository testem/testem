...
module.exports = View.extend({
  ...
  _bindKeys() {
    ...
    // _requestQuit is idempotent, so a doubled quit costs nothing. Only quit
    // belongs here: terminal-kit also emits 'key' for these bytes, and a
    // second scroll per keypress would page twice as far as the user asked.
