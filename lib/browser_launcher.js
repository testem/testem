    ...
    return  [
      ...
      },
      {
        ...
        args: function(config){
          return [path.dirname(__dirname) + '/assets/phantom.js', config.get('port')]
        },
    ...
    return [
      ...
      },
      {
        ...
        setup: function(config, done){
          ...
          fs.writeFile(tempDir + '/testem.safari.html', "<script>window.location = 'http://" + host + ":" + config.get('port') + "/'</script>", done)
        },
        args: function(){
